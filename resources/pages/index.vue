<template>
    <div class="block">
        <div class="absolute mt-4 right-0 px-10">
            <router-link to="/" class="font-serif subpixel-antialiased font-normal tracking-normal leading-loose p-2 text-gray-600">Home</router-link>
            <router-link to="/nits-admin/login" class="font-serif subpixel-antialiased font-normal tracking-normal leading-loose p-2 text-gray-600">Login</router-link>
            <router-link to="/nits-admin/register" class="font-serif subpixel-antialiased font-normal tracking-normal leading-loose p-2 text-gray-600">Register</router-link>
        </div>
