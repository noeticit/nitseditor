...
<!--                </div>-->
                <div class="mt-10 px-8 font-bold">
                    <div class="flex pb-3 relative"  v-for="item in menu">
                        <div class="mt-4 tracking-widest text-xs text-gray-700 uppercase" >{{item}}</div>
                ...
                <div class="flex mt-8 px-5 py-5">
                    ...
                    <div class="inline-block hover:bg-black cursor-pointer hover:text-white rounded text-gray-700 ">
                        <svg class="h-4 w-4 my-3 mx-3" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="relative">
            ...
            <div @click="box4 = true " :class="box4 ? 'hidden' : 'block'" class=" bg-white cursor-pointer  rounded ml-6 mt-5 absolute left-0 top-0">
            ...
            <div @click="box4 = false"  :class="box4 ? 'block' : 'hidden'" class="rounded cursor-pointer bg-white text-red-500 ml-6 mt-5 absolute left-0 top-0">
                <svg class=" h-8 w-8 px-1 py-1" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
