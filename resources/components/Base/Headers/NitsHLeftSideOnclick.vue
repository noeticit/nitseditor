<template>
    <div>
        ...
        <div  class="flex-col h-screen w-64 bg-white absolute left-0 top-0">
            ...
            <button @click="Open = ! Open" class="absolute focus:outline-none ml-64  left-0 top-0">
                <svg class="h-8 w-8  my-4 mx-3 text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
